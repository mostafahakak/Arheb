 ...
 *   2. Dashboard fixed circular zones (`delivery_fixed_zones`) — special pinned areas from App Info.
 ...
 *   5. Per-store fixed fee (`checkoutDeliveryFeeJod`) from store settings / bulk checkout policy.
 *   6. Per-store free delivery (`checkoutDeliveryFeeZero`) from store settings / bulk checkout policy.
